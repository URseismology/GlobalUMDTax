...
seq_rf = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/asia/parameter_set_1/filtered_sequenced_full.mat']);
seq_rf_pos = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/asia/parameter_set_1/filtered_pos_sequenced_full.mat']);
seq_rf_neg = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/asia/parameter_set_1/filtered_neg_sequenced_full.mat']);
...
xlabel('Depths (km)','fontweight', 'bold');
ylabel('Station Indices')
ntitle('Pos-Filtered Sequenced RF for Asia Station','location','south','fontweight', 'bold');
camroll(270)
