...
continent = 'europe';
filepath_root = ['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
...
seq_rf = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/filtered_sequenced_full.mat']);
seq_rf_pos = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/filtered_pos_sequenced_full.mat']);
seq_rf_neg = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/filtered_neg_sequenced_full.mat']);

raw_rf = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/all_sta_filt_stack_rf.mat']);
raw_rf_pos = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/all_sta_filt_pos_stack_rf.mat']);
raw_rf_neg = load(['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/' ...
    'GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/europe/parameter_set_1/all_sta_filt_neg_stack_rf.mat']);
...
subplot(3,2,2);
for i=1:size(seq_rf.dataset_imageRFs_reordered,1)
    trace=seq_rf.dataset_imageRFs_reordered(i,:) - mean(seq_rf.dataset_imageRFs_reordered(i,:));
...
xticks([60 100 140 180 220 260 300 340]);
xlim([60 350]);
ylim([0, size(seq_rf.dataset_imageRFs_reordered , 1) + 1]);
xlabel('Depths (km)','fontweight', 'bold');
ylabel('Station Indices')
...
xlabel('Depths (km)','fontweight', 'bold');
ylabel('Station Indices')
ntitle('Pos-Filtered Sequenced RF for Europe Station','location','south','fontweight', 'bold');
camroll(270)


saveas(h1,[filepath_root 'sequencer_summary_plot'],'png');
%%
