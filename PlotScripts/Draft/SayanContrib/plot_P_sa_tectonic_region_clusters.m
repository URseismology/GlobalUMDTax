...
rectangle('position',[0,0,1.1,1],'FaceColor','white');
for i = 1:4
...
%%
saveas(h1, ['/scratch/tolugboj_lab/Sayan_Swar_WS/PythonEnv/Python_Notebooks/GoGlobal/scripts/rf_prep_slurm_step_7/srtfista_output/south america/parameter_set_1/' 'SA_PVG_Tectonic_Plot.jpg']);
